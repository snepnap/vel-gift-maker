...
function handleQuizAnswer(btn, isCorrect) {
    ...
    if (isCorrect) {
        ...
        confetti({ particleCount: 80, spread: 60, origin: { y: 0.7 }, colors: ['#ff2d92', '#9945ff', '#00ffd5'] });
...
function initGift() {
    ...
    giftBox.addEventListener('click', () => {
        ...
        confetti({ particleCount: 100, spread: 70, origin: { y: 0.6 }, colors: ['#ff2d92', '#9945ff', '#00ffd5'] });
    });
}
...
function initFinale() {
    ...
    if (yesBtn) {
        yesBtn.addEventListener('click', () => {
            ...
            const colors = ['#ff2d92', '#9945ff', '#00ffd5'];
...
function updateContent() {
    ...
    if (letterTitle && CONFIG.partnerName) letterTitle.textContent = `> To: ${CONFIG.partnerName}`;
